...
def make_request(method: str, url: str, headers: Dict = None, json: Dict = None, timeout: int = 30) -> requests.Response:
...
def setup_test_environment() -> Tuple[bool, Optional[str]]:
    ...
    try:
        ...
        logger.success(f"Successfully generated API key: {api_key[:8]}...")
        return True, api_key
    except Exception as e:
...
def run_all_tests() -> Dict[str, bool]:
    ...
    logger.info(f"Test suite completed. Passed {passed_tests}/{total_tests} tests")
