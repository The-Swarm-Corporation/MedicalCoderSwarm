...
class TwitterBot:
    ...
    def setup_client(self):
        ...
        try:
            ...
            logger.info(f"Successfully connected as @{self.me.data.username}")
    ...
    def setup_stream(self):
        ...
        try:
            ...
            # Add stream rules
            self.stream.add_rules(tweepy.StreamRule(f"@{self.me.data.username}"))
    ...
    def on_tweet(self, tweet):
        ...
        try:
            ...
            if hasattr(tweet, 'referenced_tweets'):
                if any(ref.type == 'retweet' for ref in tweet.referenced_tweets):
                    return
